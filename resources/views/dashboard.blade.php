                     ...
                     <div>
                        <div class="d-flex align-items-center gap-3 mb-3">
                           <div class="bg-soft-primary avatar-60 rounded">
                              <svg class="icon-35" width="35" viewBox="0 0 24 24" fill="none" xmlns="">
                  ...
                  <div class="col-md-6">
                     <div class="iq-scroller-effect">
                        ...
                        <div class="d-flex align-items-center iq-slider mb-5 gap-2">
                           <div>
                              <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{asset('assets/images/table/1.png')}}" alt="profile" loading="lazy" />
                           </div>
                           <div>
                              <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{asset('assets/images/table/2.png')}}" alt="profile" loading="lazy" />
                           </div>
                           <div>
                              <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{asset('assets/images/table/3.png')}}" alt="profile" loading="lazy" />
                           </div>
                           <div>
                              <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{asset('assets/images/table/4.png')}}" alt="profile" loading="lazy" />
                           </div>
                           <div>
                              <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{asset('assets/images/table/5.png')}}" alt="profile" loading="lazy" />
                           </div>
                        </div>
                        <div>
