                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex justify-content-between">
                        <div class="header-title">
                            <p><a href="{{route('email-templates.create')}}" class="btn btn-success">Create New Template</a></p>
                            ...
                            <table id="email-templates-table" class="table table-striped dataTable no-footer" role="grid" aria-describedby="email-templates-table_info">
                                <thead>
                                    <tr class="ligth">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="email-templates-table">Subject</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('email-templates.show',  $template['id']) }}" class="btn btn-success">View</a>
                                            <a href="{{ route('email-templates.edit',  $template['id']) }}" class="btn btn-primary">Edit</a>
                                            <button class="btn btn-danger delete-btn" data-toggle="modal" data-target="#deleteModal" data-template-id="{{ $template['id'] }}">Delete</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<script>
     ...
     $(document).on('click', '.delete-btn', function () {
        ...
        var deleteUrl = window.location.origin + "/email-marketing/email-templates/"+ templateId;
