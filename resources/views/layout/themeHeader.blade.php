               ...
               <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                  ...
                  @if (Auth::user()->role == 'superadmin')
                     <li class="nav-item dropdown iq-responsive-menu border-end d-block">
                        <a class="nav-link <?php if(isset($slug) && in_array($slug, ['add_user', 'user_list', 'edit_user', 'user_details', 'user_deals'])){echo 'active';}?>" data-bs-toggle="dropdown" href="#sidebar-user" role="button" aria-expanded="false"
