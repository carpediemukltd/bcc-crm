                  ...
                  <div class="card-body">
                        <div class="row">      
                           ...
                           <div class="col-lg-12">
                              ...
                              <form class="upload-profile" action="<?php echo e(route('user.customfields.add')); ?>" method="POST">
                                 <div class="row">
                                    <div class="col-lg-12">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\old_crm\resources\views/admin/customfields/add.blade.php ENDPATH**/ ?>