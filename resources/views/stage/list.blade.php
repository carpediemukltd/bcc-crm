...
@section('content')
                ...
                <div class="modal-body px-4 py-4">
                    <form action="#" autocomplete="off">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="hidden" id="original_stage_title"
                                name="original_stage_title" />
                            <input type="text" class="form-control mb-0" placeholder="Stage Title" id="stage_title"
                                name="stage_title" autocomplete="off">
                        </div>

                        <div class="text-center pb-2">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="DeleteStage();">Delete</button>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function DeleteConfirm(id, title) {
            $("#stage_id").val(id);
            $("#original_stage_title").val(title);
            $("#stage_title").val("");
        ...
        function DeleteStage() {
            ...
            var original_stage_title = $("#original_stage_title").val();
            var stage_title = $("#stage_title").val();

            if (stage_title == original_stage_title) {
                alert('Deleting the stage named "' + stage_title + '"');
                $('#loading_' + stage_id).html($('#show_loading').html());
                $('#loading_' + stage_id).show();
                var url = "{{ route('stage.delete', ':stage_id') }}";
                url = url.replace(':stage_id', stage_id);
                $.post({
                    url: url,
                    type: 'POST',
                    data: {
