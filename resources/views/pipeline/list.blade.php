...
@section('content')
                                                        ...
                                                        <tr class="odd" id="{{ $rec->id }}">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="javascript:void(0)"
                                                                    ...
                                                                    <svg fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-32"
    ...
    <script type="text/javascript">
        ...
        $('.addClickrBtn').click(function() {
            ...
            c = parseInt(c) + 1;
            var tr = '<tr id="' + c + '"><td><input type="text" placeholder="New Pipeline" id="pipeline_' + c +
                '" name="pipeline_' + c + '" class="form-control" required></div><div id="loading_' + c +
                '" style="display: none;"></td><td class="text-center"> <div class="add-clicker-btns d-flex justify-content">';
