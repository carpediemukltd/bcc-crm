                  ...
                  <div class="offcanvas offcanvas-end shadow-none iq-product-menu-responsive" tabindex="-1" id="offcanvasBottom">
                     <div class="offcanvas-body">
                        <ul class="iq-nav-menu list-unstyled">
                           ...
                           @if (Auth::user()->role == 'superadmin')
                           <li class="nav-item iq-responsive-menu d-block">
                              <a class="nav-link menu-arrow justify-content-start <?php if(isset($_GET['type']) && $_GET['type'] == 'admin'){echo 'active';} ?>" data-bs-toggle="collapse" href="#allPagesData2" role="button" aria-expanded="false" aria-controls="allPagesData2">
                                 <i class="icon">
