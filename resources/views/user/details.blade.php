               ...
               <div class="d-flex flex-wrap align-items-center justify-content-between">
                  <div class="mb-3 mb-sm-0 contact_user_details">
                     ...
                     <a class="" href="tel:{{$user->phone_number}}">
                        <i class="user_icon icon">
                           <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="22" class="icon-22" height="22" viewBox="0 0 22 22">
                     ...
                     <a class="" href="https://dashboard.bccusa.com/user/documents/view/{{$user->id}}" target="_blank">
                        <i class="user_icon icon">
                        <svg fill="none" style="width:20px" xmlns="http://www.w3.org/2000/svg" class="icon-32" width="32" height="32" viewBox="0 0 24 24">
