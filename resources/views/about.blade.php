...
<div class="content-inner about-section container" >
   <div class="row">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     <div class="content-column ">
                        <div class="inner-column">
                           <div class="sec-title">
                              <span class="title">About BCC</span>
                              <h2>We are BCC bank portal to help people.</h2>
                           </div>
                        ...
                        <div class="inner-column wow fadeInLeft">
                           ...
                           <figure class="image-1">
                              <a href="#" class="lightbox-image" data-fancybox="images">
                                 <img title="Rahul Kumar Yadav" src="{{asset('assets/images/apply-for-forgiveness.jpg')}}" alt="">
                              </a>
                           </figure>
                        </div>
                     </div>
