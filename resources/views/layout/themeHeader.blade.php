                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown-search-11"
                                       ...
                                       <li class="nav-item">
                                          <a class="nav-link <?php if(isset($slug) && $slug == 'add_user' && !isset($_GET['type'])){echo 'active';}?>"
                                             ...
                                             <span class="item-name"> Custom SMTPs</span>
                                          </a>
                                       </li>
                                       <li class="nav-item">
    ...
    <path d="M15.8325 8.17463L10.109 13.9592L3.59944 9.88767C2.66675 9.30414 2.86077 7.88744 3.91572 7.57893L19.3712 3.05277C20.3373 2.76963 21.2326 3.67283 20.9456 4.642L16.3731 20.0868C16.0598 21.1432 14.6512 21.332 14.0732 20.3953L10.106 13.9602" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                           ...
                           <li class="nav-item <?php if(isset($slug) && in_array($slug, ['deals_company', 'stages', 'roundrobin', 'companies', 'list_company', 'edit_company', 'add_company','pipelines', 'add_user', 'user_list', 'edit_user', 'user_details', 'user_deals', 'user_add_deal', 'user_edit_deal']) && !isset($_GET['type'])){echo 'active';}?>">
                              ...
                              <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData3">
                                 ...
                                 @if (Auth::user()->role == 'superadmin')
                                 <li class="nav-item dropdown iq-responsive-menu d-block">
                                    <a class="nav-link <?php if(isset($slug) && in_array($slug, ['smtps', 'create_smtp', 'email_templates', 'create_email_template']) && !isset($_GET['type'])){echo 'active';}?>" data-bs-toggle="dropdown" href="#sidebar-user" role="button" aria-expanded="false"
                                       aria-controls="sidebar-special">
                                       <i class="icon">
                                          <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="">
                                             <path
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown-search-11"
                                       >
                                       <li class="nav-item">
                                          <a class="nav-link <?php if(isset($slug) && $slug == 'smtps' && !isset($_GET['type'])){echo 'active';}?>"
                                             href="{{route('custom-smtps.index')}}">
                                             <i class="icon">
                                                <svg width="20" class="icon-20" height="20" viewBox="0 0 24 24" fill="none"
                                                   xmlns="">
                                             ...
                                             <span class="item-name">SMTPs</span>
                                          </a>
                                       </li>
                                       <li class="nav-item">
