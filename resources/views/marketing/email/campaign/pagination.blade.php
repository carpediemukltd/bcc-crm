...
<tr class="odd">
   ...
   <td>
      ...
      <button class="btn btn-success activate-btn" data-bs-toggle="modal" data-campaign-id="{{$campaign->id}}">
      ...
      |
      <button class="btn btn-warning delete-btn" data-bs-toggle="modal" data-campaign-id="{{$campaign->id}}">
      ...
      <button class="btn btn-danger delete-btn" data-bs-toggle="modal" data-campaign-id="{{$campaign->id}}">
