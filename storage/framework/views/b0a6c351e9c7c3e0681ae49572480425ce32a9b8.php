   ...
   <div class="pb-1">
      ...
      <div id="dealsTable" data-list="{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;phone&quot;,&quot;contact&quot;,&quot;company&quot;,&quot;date&quot;],&quot;page&quot;:10,&quot;pagination&quot;:true}">
         ...
         <div class="row g-3 justify-content-between mb-4">
            <div class="col-md-4">
               <a href="<?php echo e(route('user.customfields.add')); ?>">
         ...
         <div class="px-4 mx-lg-n6 px-lg-6">
            <div class="table-responsive scrollbar mx-n1 px-1 border-top">
               <table class="table fs--1 mb-0 leads-table">
                  <thead>
                     <tr>
                        <th class="sort white-space-nowrap align-middle text-uppercase">Name</th>
                        <th class="sort white-space-nowrap align-middle text-uppercase">Type</th>
                        <th class="sort white-space-nowrap align-middle text-uppercase" width="3%"></th>
                     </tr>
                  </thead>
                  
                  <tbody class="list" id="deal-tables-body">
                     <?php echo $__env->make('admin.customfields.fields_pagination', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                  </tbody>
               </table>
...
<script>
   var ENDPOINT = "<?php echo e(url('user/customfields')); ?>";
   $(document).ready(function(){
      const fetch_data = (page, status, seach_term) => {
         ...
         $.ajax({ 
               url: ENDPOINT+ "/?page="+page+"&status="+status+"&seach_term="+seach_term,
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\old_crm\resources\views/admin/customfields/list.blade.php ENDPATH**/ ?>