      ...
      <div class="modal-dialog modal-md">
         <div class="modal-content overflow-hidden">
            <div class="modal-header position-relative p-0">
               ...
               <img class="w-100" src="{{asset('assets/theme/images/35.png')}}" alt="" style="max-height: 200px;min-height: 150px;">
            </div>
                                 ...
                                 <div class="position-relative">
                                    ...
                                    <div class="p-3">
                                       ...
                                       <div class="text-center">
                                          <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2 mb-2"><img class="rounded-circle border border-white" src="{{asset('assets/theme/images/35.png')}}" alt=""></div>
