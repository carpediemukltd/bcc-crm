   ...
   <tr class="odd">
      ...
      <td>
         <div class="flex align-items-center list-user-action">
            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" data-original-title="Edit" href="{{route('user.edit', $company->id)}}" aria-label="Edit" data-bs-original-title="Edit">
