               ...
               <div class="card has-blue-border">
                  <div class="card-header">
                     <div class="card-title mb-0">
                        <h3 class="mb-0">Edit Custom Field</h3>
                     </div>
                  </div>
                  <div class="card-body">
                        <div class="row">      
                           ...
                           <div class="col-lg-12">
                              ...
                              <form class="upload-profile" action="<?php echo e(route('user.customfields.edit', $rs_field->id)); ?>" method="POST">
                                 <div class="row">
                                    <div class="col-lg-12">
                                       <div class="form-group p-0 mb-3">
                                          <label class="form-label">Title</label>
                                          <input required type="text" class="form-control form-control-lg" value="<?=$rs_field->title;?>" name="title">
                                       </div>
                                    </div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\old_crm\resources\views/admin/customfields/edit.blade.php ENDPATH**/ ?>