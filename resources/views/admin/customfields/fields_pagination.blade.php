@foreach($rs_fields as $rec_field)
   ...
   <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
      <div class="font-sans-serif btn-reveal-trigger position-static">
         ...
         <div class="dropdown-menu dropdown-menu-end py-2">
            <a class="dropdown-item" href="{{route('user.customfields.edit', $rec_field->id)}}">View</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item text-danger" href="{{route('user.customfields.delete', $rec_field->id)}}">Remove</a>
         </div>
      </div>
   </td>
</tr>
...
<tr>
    <td colspan="6" align="center">
      {!! $rs_fields->links('admin.customfields.custom_pagination') !!}
    </td>
</tr>