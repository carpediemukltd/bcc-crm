                        ...
                        <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                           <li class="nav-item dropdown hidden-caret submenu">
                              <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
                                 <div class="avatar-sm">
                                    <img src="{{asset('uploads/images/placeholder-user.jpg')}}" alt="..." class="avatar-img rounded-circle">
                                 </div>
                              </a>
                                 ...
                                 <div class="scroll-wrapper dropdown-user-scroll scrollbar-outer" style="position: relative;">
                                    <div class="dropdown-user-scroll scrollbar-outer scroll-content" style="height: 175.328px; margin-bottom: 0px; margin-right: 0px; max-height: none;">
                                       ...
                                       <li>
                                          ...
                                          <a class="dropdown-item fancy-logout-btn" href="{{route('user.logout')}}">Logout</a>
                                       </li>
                                    </div>
                                 </div>
                              </ul>
               ...
               <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                  <li class="nav-item">
                     ...
                     <div class="nav-item-wrapper">
                        <a class="nav-link label-1" href="{{route('user.dashboard')}}" role="button" data-bs-toggle="" aria-expanded="false">
                     ...
                     <!--  -->
                     <div class="nav-item-wrapper">
                        <a class="nav-link label-1" href="{{route('user.contactlisting')}}" data-bs-toggle="" aria-expanded="false">
                           <div class="d-flex align-items-center">
                              <span class="nav-link-icon">
