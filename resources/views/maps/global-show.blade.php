...
<script>
    (async () => {
        ...
        const data = [
                ...
                ['Alabama', 1, 1318255, 44467, 9391, 2101660, -1],
                ...
                accessibility: {
                    point: {
                        descriptionFormatter(point) {
                            const party = point.value > 0 ? 'Capital One Bank' : 'Bank of America';
                            return point.name + ', ' + party + '. Total votes: ' + point.sumVotes +
                                '. Capital One Bank: ' + point.demVotes + '. Bank of America : ' + point.repVotes +
                                '. Chase: ' + point.libVotes + '. Truist Bank: ' + point.grnVotes + '.';
                        }
                    }
                },
                borderColor: '#FFF',
                ...
                tooltip: {
                    ...
                    pointFormatter() {
                        ...
                        return '<b>' + this.id + ' votes</b><br/>' + [
                                ['Capital One Bank', this.demVotes, demColor],
                                ['Bank of America', this.repVotes, repColor],
                                ['Chase', this.libVotes, libColor],
                                ['Truist Bank', this.grnVotes, grnColor]
                            ]
