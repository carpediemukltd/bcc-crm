                     ...
                     <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div data-setting="attribute" class="text-center">
                           ...
                           <label class="btn btn-border d-block p-0" for="theme-scheme-direction-ltr">
                              <img src="{{asset('assets/images/settings/dark/01.png')}}" alt="ltr" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/01.png')}}" alt="ltr" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                        ...
                        <div data-setting="attribute" class="text-center">
                           ...
                           <label class="btn btn-border d-block p-0" for="theme-scheme-direction-rtl">
                              <img src="{{asset('assets/images/settings/dark/02.png')}}" alt="ltr" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/02.png')}}" alt="ltr" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                  ...
                  <div>
                     <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                           ...
                           <div data-setting="radio">
                              <input type="radio" value="theme-color-default" class="btn-check" name="theme_color" id="theme-color-default" data-colors='{"primary": "#00562c", "info": "#08B1BA"}'>
                     ...
                     <div class="collapse" id="custom-color">
                        <div class="form-group d-flex justify-content-between align-items-center">
                           ...
                           <input class="" name="theme_color" data-extra="primary" type="color" id="custom-primary-color" value="#00562c" data-setting="color">
                        </div>
                     ...
                     <div class="d-grid gap-3 grid-cols-4 mb-4">
                        <div data-setting="checkbox" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="sidebar-mini">
                              <img src="{{asset('assets/images/settings/dark/03.png')}}" alt="mini" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/03.png')}}" alt="mini" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                        ...
                        <div data-setting="checkbox" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="sidebar-hover">
                              <img src="{{asset('assets/images/settings/dark/04.png')}}" alt="hover" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/04.png')}}" alt="hover" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                        ...
                        <div data-setting="checkbox" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="sidebar-boxed">
                              <img src="{{asset('assets/images/settings/dark/05.png')}}" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/05.png')}}" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                     ...
                     <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-rounded">
                              <img src="{{asset('assets/images/settings/dark/06.png')}}" alt="mini" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/06.png')}}" alt="mini" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                        ...
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-rounded-all">
                              <img src="{{asset('assets/images/settings/dark/07.png')}}" alt="hover" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/07.png')}}" alt="hover" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                        ...
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill">
                              <img src="{{asset('assets/images/settings/dark/08.png')}}" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/08.png')}}" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                        ...
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill-all">
                              <img src="{{asset('assets/images/settings/dark/09.png')}}" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/09.png')}}" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                        ...
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border position-relative p-0 d-block overflow-hidden" for="left-bordered">
                              <img src="{{asset('assets/images/settings/dark/14.png')}}" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/14.png')}}" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                        ...
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border position-relative p-0 d-block overflow-hidden" for="navs-full-width">
                              <img src="{{asset('assets/images/settings/dark/15.png')}}" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/15.png')}}" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                              <small class="badge bg-danger position-absolute top-1 end-0 m-2">Pro</small>
                           </label>
                     ...
                     <div class="d-grid gap-3 grid-cols-4 mb-4">
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="nav-glass">
                              <img src="{{asset('assets/images/settings/dark/10.png')}}" alt="hover" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/10.png')}}" alt="hover" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                        ...
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-transparent">
                              <img src="{{asset('assets/images/settings/dark/12.png')}}" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/12.png')}}" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                        ...
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-default">
                              <img src="{{asset('assets/images/settings/dark/01.png')}}" alt="default" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/01.png')}}" alt="default" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
                     ...
                     <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div data-setting="radio" class="text-center">
                           ...
                           <label class="btn btn-border p-0 d-block overflow-hidden" for="header-banner-color">
                              <img src="{{asset('assets/images/settings/dark/11.png')}}" alt="hover" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                              <img src="{{asset('assets/images/settings/light/11.png')}}" alt="hover" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                           </label>
